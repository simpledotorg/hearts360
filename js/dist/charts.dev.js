...
var dynamicChartSegementDashed = function dynamicChartSegementDashed(ctx, numberOfXAxisTicks) {
  var numberOfDashedSegments = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
  var dashStyle = [4, 3];
  var segmentStartIndex = ctx.p0DataIndex;
...
function baseLineChartConfig() {
  var colors = dashboardReportsChartJSColors();
  return {
    type: "line",
    options: {
      animation: false,
...
intersectDataVerticalLine = {
  ...
  beforeDraw: function beforeDraw(chart) {
    if (chart.tooltip._active && chart.tooltip._active.length) {
      ...
      var chartArea = chart.chartArea; // grey vertical hover line - full chart height
      ...
      ctx.stroke();
      ctx.restore(); // colored vertical hover line - ['node' point to chart bottom] - only for line graphs (graphs with 1 data point)
...
var bpControlledData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "BP controlled",
    data: [28, 23, 32, 34, 43, 34, 43, 44, 46, 43, 52, 57, 57, 59, 56, 60, 61, 55],
    borderColor: "#3BB231",
    backgroundColor: "rgba(69, 205, 57, 0.1)",
    segment: {
      borderDash: function borderDash(ctx) {
        return dynamicChartSegementDashed(ctx, 18 // number of data elements
        );
      }
    }
  }]
};
var bpControlledConfig = baseLineChartConfig();
bpControlledConfig.data = bpControlledData;

var percentageLabel = function percentageLabel(context) {
  return "".concat(context.dataset.label, ": ").concat(context.parsed.y, "%");
};

bpControlledConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var bpControlledCanvas = document.getElementById("bpcontrolled");
...
var bpUncontrolledData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "BP uncontrolled",
    data: [54, 51, 46, 45, 44, 47, 37, 33, 36, 37, 30, 28, 24, 24, 18, 17, 17, 20],
    borderColor: "#D19600",
...
var bpUncontrolledConfig = baseLineChartConfig();
bpUncontrolledConfig.data = bpUncontrolledData;
bpUncontrolledConfig.options.plugins.tooltip.callbacks = {
  label: percentageLabel
};

bpUncontrolledConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};

var bpUncontrolledCanvas = document.getElementById("bpuncontrolled");
...
var ltfu3MonthData = {
  ...
  datasets: [{
    ...
    data: [18, 26, 22, 21, 13, 19, 20, 23, 18, 20, 18, 15, 19, 17, 26, 21, 22, 25],
    borderColor: "#ed6300",
...
var ltfu3MonthConfig = baseLineChartConfig();
ltfu3MonthConfig.data = ltfu3MonthData;
ltfu3MonthConfig.options.plugins.tooltip.callbacks = {
  label: percentageLabel
};

ltfu3MonthConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};

var ltfu3MonthCanvas = document.getElementById("ltfu3Month");
...
var registrationsData = {
  ...
  datasets: [{
    ...
    data: [3074, 3719, 3989, 4308, 4958, 5338, 5705, 5975, 6284, 6762, 7019, 7523, 8043, 8941, 9906, 11062, 12105, 12213],
    borderColor: "#007ee4",
    backgroundColor: "transparent",
    yAxisID: "y"
  }, {
    label: "Patients under care",
    data: [3063, 3716, 3984, 4301, 4903, 5217, 5505, 5678, 5895, 6223, 6438, 6768, 7146, 7882, 8649, 9648, 10539, 10632],
    borderColor: "#b51bdc",
    backgroundColor: "transparent",
    yAxisID: "y"
  }, {
    ...
    data: [786, 303, 270, 319, 650, 380, 285, 270, 309, 362, 257, 504, 520, 604, 965, 1156, 1043, 236],
    borderColor: "#BEDFF9",
    backgroundColor: "#BEDFF9",
    yAxisID: "yMonthlyRegistrations"
  }]
};
var registrationsConfig = baseLineChartConfig();
registrationsConfig.data = registrationsData;
registrationsConfig.options.scales.y.grid = {
  drawTicks: false
};
...
var registrationsCanvas = document.getElementById("registrations");
...
var ltfu12MonthsConfig = baseLineChartConfig();
ltfu12MonthsConfig.data = ltfu12MonthsData;
ltfu12MonthsConfig.options.plugins.tooltip.callbacks = {
  label: percentageLabel
};

ltfu12MonthsConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};

var ltfu12MonthsCanvas = document.getElementById("ltfu12Months");
...
var screeningsData = {
  labels: ["Mar-2022", "Apr-2022", "May-2022", "Jun-2022", "Jul-2022", "Aug-2022", "Sep-2022", "Oct-2022", "Nov-2022", "Dec-2022", "Jan-2023", "Feb-2023", "Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023"],
  datasets: [{
    label: "% of patients screened",
    data: [10, 15, 16, 12, 11, 10, 9, 11, 14, 20, 22, 23, 23, 24, 23, 24, 23, 6],
    segment: {
      borderDash: function borderDash(ctx) {
        return dynamicChartSegementDashed(ctx, 18 // number of data elements
        );
    ...
    data: [2000, 2200, 2300, 2200, 1600, 1800, 3400, 3600, 3900, 5800, 5700, 5600, 6600, 6200, 6000, 6500, 6900, 500],
    borderColor: "#C5E5E2",
    backgroundColor: "#C5E5E2",
    yAxisID: "yMonthlyscreenings"
  }]
};
var screeningsConfig = baseLineChartConfig();
screeningsConfig.data = screeningsData;
console.log(screeningsConfig.options.scales.y);
screeningsConfig.options.scales.y.grid = {
  drawTicks: false
};
screeningsConfig.options.scales.y.ticks.display = false;
screeningsConfig.options.scales.y.ticks.count = 5;

screeningsConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var screeningsCanvas = document.getElementById("screenings");
...
var drugStockData = {
  ...
  datasets: [{
    ...
    data: [96, 94, 90, 80, 70, 70, 71, 72, 73, 74, 75, 76, 78, 86, 96, 95, 94, 94],
    borderColor: "#222",
    backgroundColor: "transparent",
    segment: {
      borderDash: function borderDash(ctx) {
    ...
    data: [86, 84, 80, 70, 40, 30, 31, 32, 33, 34, 30, 46, 48, 46, 56, 55, 64, 64],
    borderColor: "#D8DB56",
    backgroundColor: "transparent",
    segment: {
      borderDash: function borderDash(ctx) {
    ...
    data: [90, 92, 92, 90, 90, 90, 91, 92, 93, 94, 90, 96, 98, 92, 94, 92, 92, 90],
    borderColor: "#18D6A8",
    backgroundColor: "transparent",
    segment: {
      borderDash: function borderDash(ctx) {
...
var drugStockConfig = baseLineChartConfig();
drugStockConfig.data = drugStockData;

var stockLabel = function stockLabel(context) {
  return "".concat(context.dataset.label, ": ").concat(context.parsed.y, "%");
};
...
drugStockConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var drugStockCanvas = document.getElementById("drugstock");
...
var dmControlledData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "Blood sugar controlled",
    data: [12, 18, 19, 14, 10, 12, 13, 14, 16, 18, 20, 22, 20, 16, 14, 17, 20, 22],
    borderColor: "#3BB231",
    backgroundColor: "rgba(69, 205, 57, 0.1)",
    segment: {
      borderDash: function borderDash(ctx) {
...
dmControlledConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var dmUncontrolledData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "Blood sugar not controlled (total)",
    data: [50, 46, 49, 56, 62, 61, 61, 64, 61, 60, 56, 56, 60, 58, 64, 62, 58, 56],
    borderColor: "#D19600",
    backgroundColor: "transparent",
    yAxisID: "y",
    segment: {
    ...
    data: [15, 14, 15, 17, 19, 18, 18, 19, 18, 18, 17, 17, 18, 17, 19, 19, 17, 17],
    ...
    data: [35, 32, 34, 39, 43, 43, 43, 45, 43, 42, 39, 39, 42, 41, 45, 43, 41, 39],
...
dmUncontrolledConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var dmLtfu3MonthData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "No visit in past 3 months",
    data: [38, 36, 32, 30, 28, 27, 26, 22, 23, 22, 24, 22, 20, 26, 22, 21, 22, 22],
    borderColor: "#ed6300",
    backgroundColor: "rgba(230, 137, 70, 0.1)",
    segment: {
      borderDash: function borderDash(ctx) {
...
var dmLtfu3MonthConfig = baseLineChartConfig();
dmLtfu3MonthConfig.data = dmLtfu3MonthData;
dmLtfu3MonthConfig.options.plugins.tooltip.callbacks = {
  label: percentageLabel
};

dmLtfu3MonthConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};

var dmLtfu3MonthCanvas = document.getElementById("dmLtfu3Month");
...
var dmRegistrationsData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "Cumulative registrations",
    data: [900, 1000, 1100, 1200, 1400, 1500, 2000, 2500, 2750, 3000, 3200, 3500, 3750, 3900, 4000, 4050, 4100, 4150],
    borderColor: "#007ee4",
    backgroundColor: "transparent",
    yAxisID: "y"
  }, {
    label: "Patients under care",
    data: [720, 810, 900, 990, 1180, 1250, 1700, 2150, 2350, 2580, 2750, 3030, 3250, 3380, 3440, 3470, 3500, 3500],
    borderColor: "#b51bdc",
    backgroundColor: "transparent",
    yAxisID: "y"
  }, {
    type: "bar",
    label: "Monthly registrations",
    data: [150, 100, 100, 100, 200, 100, 500, 500, 250, 250, 200, 300, 250, 150, 100, 50, 50, 50],
    borderColor: "#BEDFF9",
    backgroundColor: "#BEDFF9",
    yAxisID: "yMonthlyRegistrations"
  }]
...
dmRegistrationsConfig.options.scales.y.grid = {
  drawTicks: false
};
...
var dmLtfu12MonthsConfig = baseLineChartConfig();
dmLtfu12MonthsConfig.data = dmLtfu12MonthsData;
dmLtfu12MonthsConfig.options.plugins.tooltip.callbacks = {
  label: percentageLabel
};

dmLtfu12MonthsConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};

var dmLtfu12MonthsCanvas = document.getElementById("dmltfu12months");
...
var dmScreeningsData = {
  ...
  datasets: [{
    ...
    type: "bar",
    label: "Monthly screenings",
    data: [2400, 1500, 1500, 1800, 1500, 1800, 1800, 2100, 2400, 2700, 3000, 3000, 3000, 2700, 3000, 3600, 4800, 600],
    borderColor: "#C5E5E2",
    backgroundColor: "#C5E5E2",
    yAxisID: "yMonthlyscreenings"
  }]
};
var dmScreeningsConfig = baseLineChartConfig();
dmScreeningsConfig.data = dmScreeningsData;
console.log(dmScreeningsConfig.options.scales.y);
dmScreeningsConfig.options.scales.y.grid = {
  drawTicks: false
};
dmScreeningsConfig.options.scales.y.ticks.display = false;
dmScreeningsConfig.options.scales.y.ticks.count = 5;

dmScreeningsConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var dmStatinsData = {
  ...
  datasets: [{
    ...
    data: [30, 32, 35, 42, 38, 36, 37, 38, 40, 36, 40, 42, 50, 45, 60, 64, 66, 64],
    borderColor: "#666666",
...
var dmStatinsConfig = baseLineChartConfig();
dmStatinsConfig.data = dmStatinsData;
dmStatinsConfig.options.plugins.tooltip.callbacks = {
  label: percentageLabel
};

dmStatinsConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};

var dmStatinsCanvas = document.getElementById("dmstatins");
...
var comorbidControlledData = {
  labels: ["Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024", "Aug-2024"],
  datasets: [{
    label: "BP controlled",
    data: [26, 28, 31, 30, 30, 32, 36, 38, 39, 41, 40, 42, 45, 44, 45, 47, 50, 48],
    borderColor: "#3BB231",
    backgroundColor: "rgba(69, 205, 57, 0.1)",
    segment: {
      borderDash: function borderDash(ctx) {
...
var comorbidControlledConfig = baseLineChartConfig();
comorbidControlledConfig.data = comorbidControlledData;

comorbidControlledConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var comorbidControlledCanvas = document.getElementById("comodrbidcontrolled");
...
var dmDrugStockConfig = baseLineChartConfig();
dmDrugStockConfig.data = dmDrugStockData;
dmDrugStockConfig.options.plugins.tooltip.callbacks = {
  label: stockLabel
};

dmDrugStockConfig.options.scales.y.ticks.callback = function (val) {
  return val + "%";
};
...
var dmDrugStockCanvas = document.getElementById("dmdrugstock");
...
var patientsProtectedData = {
  labels: ["Aug-2021", "Sep-2021", "Oct-2021", "Nov-2021", "Dec-2021", "Jan-2022", "Feb-2022", "Mar-2022", "Apr-2022", "May-2022", "Jun-2022", "Jul-2022", "Aug-2022", "Sep-2022", "Oct-2022", "Nov-2022", "Dec-2022", "Jan-2023", "Feb-2023", "Mar-2023", "Apr-2023", "May-2023", "Jun-2023", "Jul-2023", "Aug-2023", "Sep-2023", "Oct-2023", "Nov-2023", "Dec-2023", "Jan-2024", "Feb-2024", "Mar-2024", "Apr-2024", "May-2024", "Jun-2024", "Jul-2024"],
  datasets: [{
    label: "Patients with BP <140/90",
    data: [10, 120, 140, 160, 130, 120, 150, 200, 260, 310, 400, 450, 500, 550, 600, 650, 700, 710, 720, 750, 800, 830, 880, 908, 1244, 1412, 1646, 1800, 2644, 2809, 3087, 3245, 3688, 3867, 4106, 4808],
    borderColor: "#3BB231",
    backgroundColor: "rgba(69, 205, 57, 0.1)"
  }]
};
var patientsProtectedConfig = baseLineChartConfig();
patientsProtectedConfig.data = patientsProtectedData;
patientsProtectedConfig.options.scales.y.grid = {
  drawTicks: false
};
...
var patientsProtectedCanvas = document.getElementById("patientsprotected");
